...
![GitHub commit
activity](https://img.shields.io/github/commit-activity/y/atmoschem/rtorf)[![R-CMD-check](https://github.com/atmoschem/rtorf/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/atmoschem/rtorf/actions/workflows/R-CMD-check.yaml)
![GitHub Repo
...
e.g. for the `aircraft-pfp` we can read $`CO_2`$ and
$`CH_4`$[here](https://atmoschem.github.io/rtorf/articles/aircraft-pfp.html)
...
[![](http://reporoster.com/stars/dark/atmoschem/rtorf)](https://github.com/atmoschem/rtorf/stargazers)
