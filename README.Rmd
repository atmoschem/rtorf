...
e.g. for the `aircraft-pfp` we can read $CO_2$ and $CH_4$ [here](https://ibarraespinosa.github.io/rtorf/articles/aircraft-pfp.html)

## Implementation in python:

I'm currently implementing a version in python [pytorf](https://github.com/ibarraespinosa/pytorf):
...
<p>
  <a href="https://github.com/ibarraespinosa/rtorf/stargazers">
    <img src="http://reporoster.com/stars/dark/ibarraespinosa/rtorf"/>
  </a>
</p>
